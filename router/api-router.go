...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			// Kiro OAuth routes (Builder ID only)
			channelRoute.POST("/kiro/oauth/builderid/start", controller.StartKiroBuilderIDOAuth)
			channelRoute.POST("/kiro/oauth/builderid/poll", controller.PollKiroBuilderIDToken)
			channelRoute.POST("/:id/kiro/oauth/builderid/start", controller.StartKiroBuilderIDOAuthForChannel)
